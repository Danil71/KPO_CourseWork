    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.cors(Customizer.withDefaults())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(Constants.API_URL + Constants.LOGIN_URL).permitAll()
                        .requestMatchers(Constants.API_URL + "/**").permitAll()
                        .requestMatchers(Constants.API_URL + Constants.ADMIN_PREFIX + "/**").permitAll()
