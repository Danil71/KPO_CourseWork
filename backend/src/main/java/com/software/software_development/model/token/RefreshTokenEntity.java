package com.software.software_development.model.token;

import java.util.Objects;
import java.util.Optional;

import com.software.software_development.core.security.enums.ClientType;
import com.software.software_development.model.entity.BaseEntity;
...
public class RefreshTokenEntity extends BaseEntity {
    ...
    public int hashCode() {
        return Objects.hash(
                id, token, clientType, Optional.ofNullable(user).map(UserEntity::getId).orElse(null)
        );
    }
