...
const DepartmentsForm = ({     
    ...
    return (
        <>
            <Input name='name' label='Название' value={department.name} onChange={handleChange}
                type='text' required />
            <Input name='efficiency' label='Эффективность' value={department.efficiency} onChange={handleChange}
                type='number' required />
            <Input name='specialty' label='Направление' value={department.specialty} onChange={handleChange}
                type='text' required />
            <MultiSelect
                name="taskSelection"
...
DepartmentsForm.propTypes = {
    department: PropTypes.shape({
        ...
        taskIds: PropTypes.arrayOf(PropTypes.oneOfType([PropTypes.number, PropTypes.string])),
